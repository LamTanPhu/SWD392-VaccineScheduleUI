...
const PrivateRoute = ({ children }) => {
    ...
    return (
        ...
        <Routes>
            ...
            <Route path="/payment" element={<Layout><PaymentPage /></Layout>} /> {/* Added Payment Route */}
            <Route path="/payment-confirmation" element={<Layout><PaymentConfirmationPlaceholder /></Layout>} /> {/* Added Payment Confirmation Route */}
