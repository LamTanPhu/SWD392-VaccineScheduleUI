...
const AdminEditProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const updatedUsername = response.data.username || formData.username.trim() || 'Admin';
    ...
    if (error) {
        return (
            <div className="alert alert-danger text-center" role="alert">
                {error}
                <button className="btn btn-link" onClick={() => navigate('/admin/profile')}>
                    Back to Profile
                </button>
            </div>
        );
    ...
    return (
        <div className="admin-edit-profile-page container py-2">
